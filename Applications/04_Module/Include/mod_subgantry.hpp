...
#define SUB_GANTRY_LIFT_PHYSICAL_RANGE_L 88.5f
#define SUB_GANTRY_LIFT_PHYSICAL_RANGE_R 88.5f
#define SUB_GANTRY_STRETCH_PHYSICAL_RANGE_L 280.2f
#define SUB_GANTRY_STRETCH_PHYSICAL_RANGE_R 322.7f
