...
#define RightPump_Pin GPIO_PIN_0
#define RightPump_GPIO_Port GPIOA
#define FLASH_IO3_Pin GPIO_PIN_1
#define FLASH_IO3_GPIO_Port GPIOA
#define LeftPump_Pin GPIO_PIN_2
#define LeftPump_GPIO_Port GPIOA
...
#define ArmPump_Pin GPIO_PIN_9
#define ArmPump_GPIO_Port GPIOE
